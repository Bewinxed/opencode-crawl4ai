...
async function install() {
  ...
  console.log("\nInstallation complete! Restart OpenCode to activate.");
  console.log("\nTools available: crawl4ai_fetch, crawl4ai_search, crawl4ai_extract,");
...
Commands:
  --install       Install plugin to ~/.config/opencode/plugins/
  --uninstall     Remove plugin
  searxng [port]  Start SearXNG Docker container for faster search (default: ${SEARXNG_DEFAULT_PORT})
